...
class ProductController extends Controller
{
  public function index()
  {
    ...
    $countProduct = $count_total;
    //        xử lý phân trang
    $query_additional = '';
    if (isset($_GET['title'])) {
      $query_additional .= '&title=' . $_GET['title'];
    }
    if (isset($_GET['category_child_id'])) {
      $query_additional .= '&category_child_id=' . $_GET['category_child_id'];
    }
    if (isset($_GET['category_parent_id'])) {
          $query_additional .= '&category_parent_id=' . $_GET['category_parent_id'];
    }
    $arr_params = [
        'total' => $count_total,
        'limit' => 5,
    ...
    $category_patents = $category_model->getAllCategory();
    $category_childs = $category_model->getAllCategoryChild();
    ...
    $this->content = $this->render('views/products/index.php', [
        ...
        'category_parents' => $category_patents,
  ...
  public function create()
  {
    ...
    if (isset($_POST['submit'])) {
      $category_child_id = $_POST['category_child_id'];
      $title = $_POST['title'];
      $price = $_POST['price'];
      $amount = $_POST['amount'];
      ...
      if (empty($this->error)) {
        ...
        $product_model = new Product();
        $product_model->category_child_id = $category_child_id;
