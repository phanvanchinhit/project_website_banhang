...
<h1>Danh mục cha</h1>
<a href="index.php?controller=category&action=createNew" class="btn btn-primary">
    ...
    <?php if (!empty($categories)): ?>
        <?php foreach ($categories as $category): ?>
            <tr>
                ...
                <td>
                    <a href="index.php?controller=category&action=detailNew&id=<?php echo $category['id'] ?>"
                       title="Chi tiết">
                        <i class="fa fa-eye"></i>
                    </a>
                    <a href="index.php?controller=category&action=updateNew&id=<?php echo $category['id'] ?>" title="Sửa">
                        <i class="fa fa-pencil-alt"></i>
                    </a>
                    <a href="index.php?controller=category&action=deleteNew&id=<?php echo $category['id'] ?>" title="Xóa"
