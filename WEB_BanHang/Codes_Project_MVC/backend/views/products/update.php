...
<form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group col-sm-3">
            ...
            <select name="category_child_id" class="form-control" id="category_id">
                <?php foreach ($categories as $category): ?>
                    <option style="font-weight: bold;" disabled="disabled" id="number"
                            value="<?php echo $category['id'] ?>">
                        <?php echo $category['name'] ?>
                    </option>
                    <?php foreach ($category_childs as $category_child):
                        $selected = '';
                        if ($category_child['id'] == $product['category_child_id']) {
                            $selected = 'selected';
                        }
    ...
    <div class="form-group">
        ...
        <input type="text" name="seo_title"
               value="<?php echo isset($_POST['seo_title']) ? $_POST['seo_title'] : $product['seo_title'] ?>"
               class="form-control" id="seo-title"/>
    </div>
    <div class="form-group">
        <label for="seo-description">Seo description</label>
        <input type="text" name="seo_description"
               value="<?php echo isset($_POST['seo_description']) ? $_POST['seo_description'] : $product['seo_description'] ?>"
    ...
    <div class="form-group">
        ...
        <input type="text" name="seo_keywords"
               value="<?php echo isset($_POST['seo_keywords']) ? $_POST['seo_keywords'] : $product['seo_keywords'] ?>"
