	...
	<form  name="NLpayBank" action="" method="post">
		<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td>Số tiền thanh toán: </td>
				<td>
					 <input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="<?php echo $_SESSION['nganluong_info']['price_total']; ?>">
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_fullname" class="field-check " value="<?php echo $_SESSION['nganluong_info']['fullname']; ?>">
				</td>
			</tr>
			<tr><td>Email: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_email" class="field-check " value="<?php echo $_SESSION['nganluong_info']['email']; ?>">
				</td>
			</tr>
			<tr><td>Số Điện thoại: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_mobile" class="field-check " value="<?php echo $_SESSION['nganluong_info']['mobile']; ?>">
				</td>
			</tr>				
		</table>	
