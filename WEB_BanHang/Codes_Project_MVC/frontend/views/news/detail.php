                                ...
                                <div class="blog_details">
                                    ...
                                    <div class="collapse mt-4" id="<?php echo $new['id'];?>">
                                        <div class="card card-body" style="background: #90cede">
                                            <p class="card-text">
                                            <div id="fb-root"></div>
                                            <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v9.0" nonce="8DZKfdE5"></script>
                                            <div class="fb-comments" data-href="https://www.facebook.com/BanTiviGiaReNhat" data-numposts="4" data-width=""></div>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php if(isset($categories)):?>
                                <?php foreach ($categories AS $category):?>
                                    ...
                                    <?php foreach ($category_news AS $category_new):?>
                                        <?php if ($category_new['category_id']== $category['id']) {
                                            $dem++;
                                        }
                                        ?>
                                    <?php endforeach;?>
